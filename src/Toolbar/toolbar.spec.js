...
import { Toolbar, ToolbarRow, ToolbarSection, ToolbarTitle, ToolbarFixedAdjust } from './';
...
describe('Toolbar', () => {
  ...
  it('can have custom classnames', () => {
    [ToolbarRow, ToolbarSection, ToolbarTitle, ToolbarFixedAdjust].forEach(Component => {

...
import { Card, CardMedia, CardPrimary, CardTitle, CardSubtitle, CardSupportingText, CardActions, CardAction } from './';
...
describe('Card', () => {
  ...
  it('can have custom classes', () => {
    [Card, CardMedia, CardPrimary, CardTitle, CardSubtitle, CardSupportingText, CardActions, CardAction].forEach(
      Component => {

...
export class Ripple extends React.Component {
  ...
  render() {
     ...
     */
    const rippleClasses = (this.el ? this.el.getAttribute('class').split(' ') : []).filter(cls => {
    ...
    const classes = classNames('mdc-ripple-surface', child.props.className, ...rippleClasses, {

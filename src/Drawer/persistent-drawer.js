  ...
  render() {
    ...
    return (
      <PersistentDrawerHeaderRoot {...rest}>
        <PersistentDrawerHeaderContent>{children}</PersistentDrawerHeaderContent>
  ...
  render() {
    ...
    return (
      <PersistentDrawerRoot elementRef={el => this.MDCSetRootElement(el)} {...rest}>
        <PersistentDrawerDrawer elementRef={el => (this.drawerEl = el)}>{children}</PersistentDrawerDrawer>
